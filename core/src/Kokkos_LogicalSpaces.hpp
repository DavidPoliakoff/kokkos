...
struct DefaultMemorySpaceNamer {
  static constexpr const char* get_name() { return "DefaultLogicalMemorySpaceName"; }
};
...
template<class BaseSpace, class PreferredMemorySpace = void, class Namer = DefaultExecutionSpaceNamer, class Prologue = EmptyModifier, class Epilogue = EmptyModifier>
class LogicalExecutionSpace {
 ...
 public:
  ...
  using memory_space = typename std::conditional<std::is_same<PreferredMemorySpace,void>::value,typename BaseSpace::memory_space, PreferredMemorySpace>::type;
...
template <class BaseSpace, class DefaultExecutionSpace = void, class Namer = DefaultMemorySpaceNamer,
          bool SharesAccessWithBase = true>
class LogicalMemorySpace {
 public:
  //! Tag this class as a kokkos memory space
  using memory_space =  LogicalMemorySpace<BaseSpace, DefaultExecutionSpace, Namer,
...
class SharedAllocationRecord<
 ...
 private:
  using SpaceType = Kokkos::LogicalMemorySpace<BaseSpace, DefaultExecutionSpace, Namer,
                                     SharesAccessSemanticsWithBase>;
